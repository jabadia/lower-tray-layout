        ...
        return {
            ...
            link: function(scope, element, attr) {
                ...
                var dragEnd = function(e) {
                    ...
                    scope.eventSucker.style.visibility = "hidden";
                };
                var dragStart = function(e, direction) {
                    ...
                    scope.$apply();
                    scope.eventSucker.style.visibility = "visible";
                };
                ...
                scope.eventSucker = document.createElement('div');
                scope.eventSucker.setAttribute('class','event-sucker');
                scope.eventSucker.style.visibility = "hidden";
                document.getElementsByTagName('body')[0].appendChild(scope.eventSucker);
            }
        };
    });
